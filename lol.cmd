...
cls
echo =====================================================================================
echo #Project: Activating Microsoft software products without additional software
echo =====================================================================================
echo.
...
if %errorlevel% EQU 0 (
    ...
    goto skms
) else wmic os | findstr /I "11 pro" >nul
if %errorlevel% EQU 0 (
...
cscript //nologo slmgr.vbs /ato | find /i "successfully" && (
    ...
    choice /n /c YN /m "Would you like to visit my website [Y,N]?"
    if errorlevel 2 exit
) || (
    echo The connection to my server failed! Trying to connect to another one...
    echo Dont Panic Just Chill
    echo Please wait...
    echo.
    echo.
    set /a i+=1
